...
static void llama_model_load_internal(
    ...
    const float *tensor_split, float rope_freq_base, float rope_freq_scale,
...
static bool llama_model_load(const std::string &fname, llama_model &model,
                             llama_vocab &vocab, int n_ctx, int n_batch,
                             int n_gqa, float rms_norm_eps, int n_gpu_layers,
  ...
  try {
    llama_model_load_internal(
        ...
        main_gpu, tensor_split, rope_freq_base, rope_freq_scale, low_vram,
        memory_type, use_mmap, use_mlock, vocab_only, progress_callback,
        progress_callback_user_data);
    return true;
...
struct llama_model *llama_load_model_from_file(
  ...
  if (!llama_model_load(
          ...
          params.main_gpu, params.tensor_split, params.rope_freq_base,
          params.rope_freq_scale, params.low_vram, memory_type, params.use_mmap,
